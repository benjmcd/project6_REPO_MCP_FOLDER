...
- the immediate required move is now to open the read-only deterministic challenge review-packet continuation freeze, not to restate the already-landed challenge handoff lane
