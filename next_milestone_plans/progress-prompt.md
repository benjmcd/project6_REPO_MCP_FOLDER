...
- if a future branch carries additional readiness, execution, source, results, package, handoff, or correction behavior beyond PR `#217`, keep that future behavior branch-local until GitHub and current `main` both confirm it
