...
- when `28_L3_WB_FIRST_SLICE_FREEZE.md` is present, preserve it as planning-only first-slice setup for the future workbench route family without changing the settled packet state, merged milestone count, current focus, or route/API live-state claims
