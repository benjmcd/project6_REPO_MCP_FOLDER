...
- Render `layer3_workbench_slices` as a structured workbench register; do not force PR `#184`, `#194`, `#199`, `#205`, `#207`, `#213`, `#216`, `#218`, `#222`, `#227`, PR `#232`, docs `46`/`47`, docs `48`/`49`, PR `#235`, docs `50`/`51`, or PR `#238` state to be inferred only from prose.
