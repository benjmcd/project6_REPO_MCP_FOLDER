...
- the current-horizon Candidate B decision is to keep that separate bundle-scoped posture in place
...
- Post-admission/defaulting merged-main closure/handoff: the retained-default current-horizon state is now merged-main authority and handed off by `05Q`
...
- The current-horizon retain-`baseline`-default decision is now merged-main authority through `05P` + `05Q`
- No further MVVLC implementation, promotion, or decision lane should start by inference from merged M6B closure, from the achieved planning freeze alone, or from the retained-default merged-main state itself
