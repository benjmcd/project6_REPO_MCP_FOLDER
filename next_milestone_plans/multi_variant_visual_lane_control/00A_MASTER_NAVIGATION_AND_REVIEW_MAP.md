...
If someone needs to decide whether we are ready to move from achieved M5 barrier closure into bounded M6 admission work, the minimum set is:
...
9. `05G_M5_BARRIER_IMPLEMENTATION_RECORD_AND_M6_HANDOFF.md`
10. `05H_M6_APPROVE_AS_IS_EXECUTION_PACKET.md`
11. `06E_BLOCKER_DECISION_TABLE.md`
...
8. `03K_DIAGNOSTICS_REF_PERSISTENCE_POLICY.md`
9. `03L_RUNTIME_DB_BINDING_AND_ISOLATION_POLICY.md`
10. `05G_M5_BARRIER_IMPLEMENTATION_RECORD_AND_M6_HANDOFF.md`
