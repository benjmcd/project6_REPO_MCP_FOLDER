...
7. `05E_POST_M4_APPROVAL_READY_NEXT_LANE_PLAN.md`
8. `05F_M5_APPROVE_AS_IS_EXECUTION_PACKET.md`
9. `06E_BLOCKER_DECISION_TABLE.md`
...
If someone needs to decide whether we are ready to move from merged M4 closure into controlled M5 preparation, the minimum set is:
...
8. `05E_POST_M4_APPROVAL_READY_NEXT_LANE_PLAN.md`
9. `05F_M5_APPROVE_AS_IS_EXECUTION_PACKET.md`
10. `03G_IMPLEMENTATION_SEAM_FREEZE_CHECKLIST.md`
11. `06D_CRITICAL_BLOCKER_VALIDATION_SET.md`
