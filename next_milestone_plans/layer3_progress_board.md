...
- Current selected planning boundary: after PR `#238`, the next possible planning boundary is package-review submit/decision state if that state is desired. It must be frozen separately before any durable package-review decision or handoff/export behavior is implemented.
