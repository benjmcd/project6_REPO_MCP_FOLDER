...
- PR `#258` docs `58`/`59` as APS handoff dispatch governance after `handoff_export_prepared`, PR `#260` as the bounded backend/API implementation into the existing `aps_evidence_bundle_handoff` owner-service family, and PR `#261` as fail-closed authority hardening. Rendered APS dispatch controls, external export/download, connector dispatch, destination selection, package mutation/reconstruction, schema/runtime/source widening, and full mockup activation remain out
...
- snapshot base for this APS handoff dispatch planning sync: current `project6-origin/main` after PR `#257` post-UI docs/progress sync, commit `fb16b777d674a57e9073b46144275290804e56ce`
