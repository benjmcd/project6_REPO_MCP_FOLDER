...
- snapshot base for this post-PR432 docs/control sync branch: current `project6-origin/main` at `043f4402` after PR `#432` merged bounded selected-pass associated-cohort `descriptive_summary` execution-start/result-status; PR `#432` did not admit UI, schema/runtime/source widening, result review, package/handoff/export, connector dispatch, qualitative/hybrid/RAG/vector, or full mockup behavior
