...
- snapshot base for this post-PR404 docs/control self-index branch: current `project6-origin/main` at `8b3bae6838af6e02dc3043a0aad5da8d6a7de2fe` after PR `#404` merged the post-PR402 descriptive-summary docs/control sync; PR `#404` changed only Layer 3 progress-control docs and did not modify runtime behavior
