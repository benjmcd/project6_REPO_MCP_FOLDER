...
- the pre-existing APS evidence-bundle delivery path remains admitted only when the prepare record is explicitly a non-associated-cohort `aps_evidence_bundle_download_reference` over `aps.evidence_bundle.v2`
