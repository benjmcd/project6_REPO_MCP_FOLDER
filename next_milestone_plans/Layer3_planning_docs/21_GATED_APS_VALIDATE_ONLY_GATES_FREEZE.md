...
- open PR `#140` now also carries the read-only `22_GATED_APS_VALIDATE_ONLY_RUNTIME_FREEZE.md` freeze selecting whether to admit a dedicated validate-only family-specific report-ref/runtime boundary beyond that landed generic gate-report refresh lane
