...
- Latest committed branch head before this source-preview DTO boundary hardening: `79f6ebd4`.
...
- `python -m pytest $files -q`, where `$files` is the local `backend/tests/test_layer3*.py` set, passed with `262 passed, 4 warnings`.
