...
- Latest committed branch head before this signed-reference proof hardening: `43cd5698`.
...
- `python -m pytest $files -q`, where `$files` is the local `backend/tests/test_layer3*.py` set, passed with `260 passed, 4 warnings`.
