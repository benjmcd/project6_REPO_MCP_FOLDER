...
- the later write-enabled deterministic challenge handoff lane admitted by the now-landed `19_GATED_APS_DETERMINISTIC_CHALLENGE_FREEZE.md` freeze on current `main`
