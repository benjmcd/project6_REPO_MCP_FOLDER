...
- the current branch-local read-only `19_GATED_APS_DETERMINISTIC_CHALLENGE_FREEZE.md` freeze beyond the now-landed deterministic insight handoff, which still does not admit implementation by itself
