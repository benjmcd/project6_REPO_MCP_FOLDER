...
- The harness limits were first tightened to `normalizedMeanDeltaMax: 0.30` and `highDeltaRatioMax: 0.34`, then tightened again in `278_MOCKUP_THRESHOLD_TIGHTENING.md` to `normalizedMeanDeltaMax: 0.23` and `highDeltaRatioMax: 0.32`.
