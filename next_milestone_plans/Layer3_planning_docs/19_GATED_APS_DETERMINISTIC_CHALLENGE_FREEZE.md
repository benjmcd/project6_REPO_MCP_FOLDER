...
- `R|backend/app/services/nrc_aps_deterministic_challenge_artifact_gate.py|Live deterministic challenge gate validates persisted challenge artifacts fail-closed over the current reports dir|1-205`
