...
Default-posture reconciliation, decision, and operator runbook/matrix selection are now recorded in `1268-sec-xbrl-default-posture-reconciliation.md`, `1269-sec-xbrl-default-posture-decision.md`, and `1270-sec-xbrl-operator-runbook-matrix-selection.md`. The next pass should execute or prepare the selected stratified validation matrix without changing committed defaults or admitting production/default-on behavior.
