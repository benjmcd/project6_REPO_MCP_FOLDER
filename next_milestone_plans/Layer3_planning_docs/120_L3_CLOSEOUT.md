...
| Plan revision recovery lifecycle | Bounded preview-refresh runtime live via PR `#599` | `132_PLAN_REVISION_RECOVERY_FREEZE.md`; `133_PLAN_REVISION_RECOVERY_CONTRACT.md`; `134_PLAN_REVISION_RECOVERY_ENTRY_FREEZE.md`; PR `#599` merge commit `1e74a739a07623b7d91d405d946e6b1d221be6ff`; `backend/app/services/layer3_plan_revision_recovery.py`; `backend/tests/test_layer3_plan_revision_recovery.py`; `backend/app/api/layer3.py`; `backend/app/services/layer3_state_model_contract.py`; `backend/app/services/layer3_readiness_contract.py`; `backend/app/services/layer3_bootstrap_contract.py`; `backend/tests/test_layer3_api.py`; `backend/tests/test_layer3_plan_flow_contract.py`; `backend/tests/test_layer3_state_model_contract.py`; `backend/tests/test_layer3_readiness_contract.py`; `backend/tests/test_layer3_bootstrap_contract.py`; `tools/l3-progress-check.py` | Only `plan_revision_recovery_preview_refresh_entry` is live. Not approved-plan supersession, not execution, not package/handoff/export, not connector/destination dispatch, not source widening, not broad qualitative/hybrid/RAG, not full mockup activation, and not auth/security behavior. |
