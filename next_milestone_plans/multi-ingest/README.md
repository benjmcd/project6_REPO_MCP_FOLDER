...
1. Freeze P17 mixed-source handoff/export authority only after the P16 runtime pass merges and current-main syncs.
2. Implement P17 handoff/export runtime only after that freeze defines exact downstream authority and public artifact semantics.
...
- `35-p16-runtime-closeout.md` records the branch-local mixed-source package-review submit runtime boundary.
