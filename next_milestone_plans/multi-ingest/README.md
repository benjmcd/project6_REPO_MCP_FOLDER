...
P19 freezes mixed-source external export/download readiness as the next exact downstream surface over the recorded P18 reference-only APS handoff dispatch state. It is docs/control only and does not admit external export/download readiness runtime, delivery, download, signed reference, public URL, connector, or provider behavior.
...
- `45-p19-runtime-closeout.md` records the branch-local mixed-source external export/download readiness runtime proof over P18 dispatch authority.
