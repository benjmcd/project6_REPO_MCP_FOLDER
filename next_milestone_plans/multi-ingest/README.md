...
1. Implement read-only mixed-source package review preview over the P11 material-preview readiness response, P12 contract, and P13 registry, while keeping `mixed_dataset_document` commit, submit, handoff, export, parser, schema, source-shape, and Onlook behavior blocked.
