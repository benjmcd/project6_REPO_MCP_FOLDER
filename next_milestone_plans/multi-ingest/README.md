...
1. Introduce a package-family policy registry and keep `mixed_dataset_document` blocked for commit, submit, and handoff until separate runtime passes prove the Phase P12 contract. The next code pass should not enable package construction directly.
