...
1. Merge and current-main-sync the P18 mixed-source APS handoff dispatch runtime slice after focused runtime and control-spine proof passes.
2. Freeze mixed-source external export/download readiness only after mixed-source APS handoff dispatch runtime lands and proves a recorded dispatch state on current main.
...
- `42-p18-runtime-closeout.md` records branch-local mixed-source APS handoff dispatch runtime proof over the P17 reference-only prepare state.
