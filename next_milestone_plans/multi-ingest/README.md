...
1. After this P17A freeze lands and current-main syncs, implement only the rendered material-authority handoff/export prepare status/control path.
2. Freeze the next exact mixed-source downstream surface before runtime: likely APS handoff or external export/download readiness, but not more than one at once.
