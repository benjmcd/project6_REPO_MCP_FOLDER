...
The next implementation pass should not repeat the APS-derived dataset selection or source-family surfacing slices. Remaining work is:

1. Broader Phase P10 trace/detail surfacing for typed/refused/mixed source families only as those families become backed by server authority and need more than candidate-panel guardrails.
