...
1. Define the governed mixed-source package contract after the new material-preview readiness projection identifies valid `dataset_version` plus `aps_content_document` authority. That future pass must define narrative-table linking, package payload semantics, and downstream handoff policy before enabling package construction.
