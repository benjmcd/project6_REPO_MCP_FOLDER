...
Status: branch-local rendered product-flow usability proof. Not current-main until merged and post-merge proof is recorded.
...
Superseded by branch-local P24 product-authority checkpoint for read-only
operator inspection. Merge-review and current-main sync the combined P22/P23/P24
branch-local work before selecting another downstream surface. Durable
revocation UI/API remains separate from P24 and is still safer than provider/
public URL governance or connector/destination/local-outbox dispatch.
