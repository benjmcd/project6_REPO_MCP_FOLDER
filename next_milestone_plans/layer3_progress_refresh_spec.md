...
- if current `main` includes merged docs `90_COHORT_PACKAGE_REVIEW_SUBMIT_FREEZE.md` and `91_COHORT_PACKAGE_REVIEW_SUBMIT_CONTRACT.md`, classify them as planning/control selected-pass associated-cohort package-review submit governance over exact PR `#451` package-construction authority. Do not treat docs `90`/`91` by themselves as live package-review submit, handoff, export, APS dispatch, external export/download, schema/runtime/source, connector, qualitative/hybrid/RAG/vector, retry/recovery, pass-entry, broader UI, broader associated-cohort review, or full mockup behavior. If current `main` includes merged PR `#456`, classify only bounded associated-cohort package-review submit as live over docs `90`/`91` authority; do not treat PR `#456` as handoff/export, APS dispatch, external export/download, connector, schema/runtime/source, qualitative/hybrid/RAG/vector, retry/recovery, pass-entry, broader UI, broader associated-cohort review, or full mockup behavior. If a branch includes docs `92_COHORT_HANDOFF_EXPORT_FREEZE.md` and `93_COHORT_HANDOFF_EXPORT_CONTRACT.md`, classify them as branch-local planning/control governance for future associated-cohort handoff/export prepare-only behavior until GitHub and current `main` both confirm them; do not treat docs `92`/`93` by themselves as live handoff/export, APS dispatch, external export/download, connector, package payload copy/rewrite, schema/runtime/source, retry/recovery, pass-entry, broader UI, or full mockup behavior.
- if a future branch carries additional changes beyond docs `75`/`76`, docs `77`/`78`/`79`, docs `80`/`81`, docs `82`/`83`, docs `84`/`85`, docs `86`/`87`, docs `88`/`89`, docs `90`/`91`, PR `#417`, PR `#424`/`#425`, PR `#432`, PR `#433`, PR `#434`, PR `#435`, PR `#436`, PR `#438`, PR `#441`, PR `#443`, PR `#447`, PR `#450`, PR `#451`, PR `#456`, docs `92`/`93`, or the branch-local associated-cohort handoff/export planning lane, classify them as branch-local until GitHub and current `main` both confirm them
