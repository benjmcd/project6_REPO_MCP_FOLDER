...
- if a future branch carries additional changes beyond docs `75`/`76`, docs `77`/`78`/`79`, docs `80`/`81`, PR `#417`, PR `#424`/`#425`, or PR `#432`, classify them as branch-local until GitHub and current `main` both confirm them
