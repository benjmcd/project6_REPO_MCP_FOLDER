...
- `#256`, `#257`, `#258`, `#260`, `#261`, `#263`, `#265`, `#266`, `#268`, `#269`, `#273`, `#274`, `#275`, `#277`, `#278`, `#281`, `#282`, `#283`, `#284`, `#285`, `#286`, `#289`, `#315`, `#316`, `#398`, `#399`, `#400`, `#401`, `#402`, `#404`, `#407`, `#411`, `#417`, `#422`, `#423`, `#424`, `#425`, `#426`, `#427`, `#428`, `#429`, `#430`
...
- if current `main` includes merged docs `80_COHORT_EXECUTION_FREEZE.md` and `81_COHORT_EXECUTION_CONTRACT.md`, classify them as planning-only selected-pass associated-cohort execution-start/result-status governance. Do not treat docs `80`/`81` as live selected-pass cohort execution, result review, package, handoff, export, UI behavior, schema/runtime/source widening, connector dispatch, qualitative/hybrid/RAG/vector expansion, full mockup activation, or broader associated-cohort behavior beyond future backend/API implementation-entry governance
- if a future branch carries additional changes beyond docs `75`/`76`, docs `77`/`78`/`79`, PR `#417`, or PR `#424`/`#425`, classify them as branch-local until GitHub and current `main` both confirm them
