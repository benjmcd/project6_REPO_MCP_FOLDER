...
Do not treat docs `77`/`78`/`79` or PR `#424`/`#425` as selected-pass workbench cohort breadth, API/UI activation, schema/runtime/source widening, package/handoff/export behavior, connector dispatch, qualitative/hybrid/RAG/vector behavior, full mockup activation, or broader associated-cohort behavior beyond the exact service path. Do not treat docs `80`/`81`, PR `#432`, docs `82`/`83`, PR `#438`, docs `84`/`85`, PR `#443`, docs `86`/`87`, PR `#447`, or docs `88`/`89` as package-review submit, handoff, export, schema/runtime/source, connector, qualitative/hybrid/RAG/vector, retry/recovery, pass-entry, broader UI, or full mockup behavior; docs `82`/`83` do not make result review live by themselves, docs `84`/`85` do not make UI behavior live by themselves, docs `86`/`87` do not make package-review preview live by themselves, and docs `88`/`89` do not make package construction live by themselves. If a future checkout carries revisions beyond docs `77`/`78`/`79`/`80`/`81`/`82`/`83`/`84`/`85`/`86`/`87`/`88`/`89`, PR `#443`, PR `#447`, PR `#450`, or branch `codex/l3-cohort-package-construction-impl-p61`, preserve those revisions as branch-local until GitHub and current `main` both confirm them.
