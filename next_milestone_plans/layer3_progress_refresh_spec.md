...
- `#256`, `#257`, `#258`, `#260`, `#261`, `#263`, `#265`, `#266`, `#268`, `#269`, `#273`, `#274`, `#275`, `#277`, `#278`, `#281`, `#282`, `#283`, `#284`, `#285`, `#286`, `#289`, `#315`, `#316`, `#398`, `#399`, `#400`, `#401`, `#402`, `#404`, `#407`, `#411`, `#417`, `#422`, `#423`, `#424`, `#425`, `#426`, `#427`, `#428`, `#429`, `#430`, `#431`, `#432`
...
- if current `main` includes merged docs `80_COHORT_EXECUTION_FREEZE.md` and `81_COHORT_EXECUTION_CONTRACT.md`, classify them as selected-pass associated-cohort execution-start/result-status governance. If current `main` also includes merged PR `#432`, classify only the exact backend/API selected-pass associated-cohort `descriptive_summary` execution-start/result-status path as live. Do not treat docs `80`/`81` by themselves, or PR `#432`, as selected-pass cohort result review, package, handoff, export, UI behavior, schema/runtime/source widening, connector dispatch, qualitative/hybrid/RAG/vector expansion, full mockup activation, or broader associated-cohort behavior beyond that bounded backend/API path
...
- if current `main` includes merged docs `82_COHORT_RESULT_REVIEW_FREEZE.md` and `83_COHORT_RESULT_REVIEW_CONTRACT.md`, classify them as planning-only selected-pass associated-cohort result-review governance over the exact PR `#432` execution-start/result-status path. Do not treat docs `82`/`83` by themselves as live result review, UI, package, handoff, export, schema/runtime/source, connector, qualitative/hybrid/RAG/vector, full mockup, or pass-entry behavior
- if a future branch carries additional changes beyond docs `75`/`76`, docs `77`/`78`/`79`, docs `80`/`81`, docs `82`/`83`, PR `#417`, PR `#424`/`#425`, PR `#432`, PR `#433`, PR `#434`, PR `#435`, or PR `#436`, classify them as branch-local until GitHub and current `main` both confirm them
