...
- if a future branch carries additional changes beyond docs `75`/`76`, docs `77`/`78`/`79`, docs `80`/`81`, docs `82`/`83`, PR `#417`, PR `#424`/`#425`, PR `#432`, PR `#433`, PR `#434`, PR `#435`, PR `#436`, or PR `#438`, classify them as branch-local until GitHub and current `main` both confirm them
