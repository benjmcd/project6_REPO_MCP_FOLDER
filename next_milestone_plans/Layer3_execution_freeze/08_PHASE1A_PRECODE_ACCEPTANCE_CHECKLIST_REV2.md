# 08 Phase1A Precode Acceptance Checklist REV2

## Correction Note

This revision regenerates the Phase 1A pre-code checklist from the allowed source set only.

Corrected from the prior checklist:
- source hygiene is now explicit and clean,
- checklist items were revalidated against allowed planning, curated repo-root, and baseline artifact sources only.

Retained unchanged:
- the frozen tranche acknowledgement,
- the exact owner/migration/proof defaults,
- the no-touch boundaries,
- the proof obligations and stop conditions.

Material effect on the later write-enabled session:
- no material change; this remains the checklist to clear before editing.

Evidence basis: `A|next_milestone_plans/Layer3_execution_freeze/08_PHASE1A_PRECODE_ACCEPTANCE_CHECKLIST.md|artifact|correction target`; `A|next_milestone_plans/Layer3_execution_freeze/07_PHASE1A_IMPLEMENTATION_LOCAL_DECISIONS_REV2.md|artifact|full doc`
...
Evidence basis: `A|next_milestone_plans/Layer3_execution_freeze/07_PHASE1A_IMPLEMENTATION_LOCAL_DECISIONS_REV2.md|artifact|full doc`; `A|next_milestone_plans/Layer3_execution_handoff/05_PHASE1A_PROOF_RUNBOOK_AND_STOP_CONDITIONS.md|artifact|sections 1-6`
...
- [ ] I acknowledge the exact baseline pack controlling this pass: `01_IMPLEMENTATION_ENTRY_BASELINE_REV2.md`, `02_PHASE1A_IMPLEMENTATION_PREP_SPEC_REV2.md`, `03_PHASE1A_VALIDATION_AND_EXECUTION_PLAN_REV2.md`, `04_PHASE1A_FILE_TOUCH_AND_OWNER_MATRIX.md`, `05_PHASE1A_PROOF_RUNBOOK_AND_STOP_CONDITIONS.md`, `06_PHASE1A_CODEWRITING_HANDOFF.md`, and `07_PHASE1A_IMPLEMENTATION_LOCAL_DECISIONS_REV2.md`.  
  `Evidence:` `A|next_milestone_plans/Layer3_planning_docs/01_IMPLEMENTATION_ENTRY_BASELINE_REV2.md|artifact|full doc`; `A|next_milestone_plans/Layer3_execution_handoff/04_PHASE1A_FILE_TOUCH_AND_OWNER_MATRIX.md|artifact|full doc`; `A|next_milestone_plans/Layer3_execution_freeze/07_PHASE1A_IMPLEMENTATION_LOCAL_DECISIONS_REV2.md|artifact|full doc`

- [ ] I will treat `backend/app/models/models.py` as the only already-settled direct owner surface.  
  `Evidence:` `A|next_milestone_plans/Layer3_execution_freeze/07_PHASE1A_IMPLEMENTATION_LOCAL_DECISIONS_REV2.md|artifact|section 1 item 1`; `A|next_milestone_plans/Layer3_execution_handoff/04_PHASE1A_FILE_TOUCH_AND_OWNER_MATRIX.md|artifact|models owner row`
...
- [ ] I will not touch `backend/app/schemas/api.py` unless I stop and explicitly escalate first.  
  `Evidence:` `A|next_milestone_plans/Layer3_execution_freeze/07_PHASE1A_IMPLEMENTATION_LOCAL_DECISIONS_REV2.md|artifact|section 2 item 2`
...
- [ ] I will use a test-only internal proof harness that imports the new service module directly; I will not add a temporary route or browser surface.  
  `Evidence:` `A|next_milestone_plans/Layer3_execution_freeze/07_PHASE1A_IMPLEMENTATION_LOCAL_DECISIONS_REV2.md|artifact|section 2 item 6`; `P|layer3_primary_planningdocs/06_LAYER3_ENGINE_MAP_AND_EXISTING_REPO_REUSE.md|Recommended invocation posture|141-143`
...
- [ ] I have run the recommended preflight commands and confirmed that forbidden surfaces are currently untouched before editing begins.  
  `Evidence:` `A|next_milestone_plans/Layer3_execution_freeze/07_PHASE1A_IMPLEMENTATION_LOCAL_DECISIONS_REV2.md|artifact|section 3 steps 1-2`
