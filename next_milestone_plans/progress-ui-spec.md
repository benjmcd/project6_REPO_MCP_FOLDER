...
- Render `layer3_workbench_slices` as a structured workbench register; do not make users infer PR `#184`, `#194`, `#199`, `#205`, `#207`, `#212`, `#213`, `#216`, `#218`, `#222`, or docs `44`/`45` state only from prose.
