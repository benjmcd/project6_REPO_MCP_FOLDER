...
- `live_bounded_descriptive_summary_selected_pass_cohort_result_review`: green or other clearly current-main backend/API selected-pass associated-cohort result-review state for PR `#438`; it must be limited to exact result review through the existing endpoint over PR `#432` terminal output authority and must not look like UI activation, package/handoff/export behavior, source/schema/runtime widening, pass-entry changes, retry/recovery, qualitative/hybrid/RAG/vector expansion, broader associated-cohort review, or full mockup activation
- `planning_only_descriptive_summary_selected_pass_cohort_result_review_ui`: amber or other clearly planning-only rendered UI governance state for `84_COHORT_RESULT_REVIEW_UI_FREEZE.md`/`85_COHORT_RESULT_REVIEW_UI_CONTRACT.md`; it must not look like live UI behavior, backend/API changes, package/handoff/export behavior, source/schema/runtime widening, pass-entry changes, retry/recovery, qualitative/hybrid/RAG/vector expansion, broader associated-cohort review, or full mockup activation
- `merged_live_bounded_descriptive_summary_selected_pass_cohort_package_construction_commit`: blue-green or other clearly merged-main implementation state from PR `#451`; it must not look like package-review submit, handoff/export, APS dispatch, external export/download, connector dispatch, schema/runtime/source widening, retry/recovery, pass-entry changes, broader UI, qualitative/hybrid/RAG/vector, downstream behavior, or full mockup activation
- `planning_only_descriptive_summary_selected_pass_cohort_package_review_submit`: amber or other clearly planning-only package-review submit governance state for docs `90`/`91`; it must not look like live package-review submit, handoff/export, APS dispatch, external export/download, connector dispatch, schema/runtime/source widening, retry/recovery, pass-entry changes, broader UI, qualitative/hybrid/RAG/vector, or full mockup activation
- `branch_local_planning_descriptive_summary_selected_pass_cohort_aps_handoff_dispatch`: lavender or other clearly branch-local planning-only state for future docs `94`/`95` revisions beyond PR `#464`; it must not look like current-main live APS dispatch, external export/download, connector dispatch, generic downstream dispatch, destination selection, schema/runtime/source widening, broader UI, or full mockup activation
- `planning_only_descriptive_summary_selected_pass_cohort_aps_handoff_dispatch`: amber or other clearly planning-only APS-dispatch governance state for docs `94`/`95` after PR `#464` merge; it must not look like live APS dispatch by itself, external export/download, connector dispatch, generic downstream dispatch, destination selection, package mutation/reconstruction, schema/runtime/source widening, broader UI, or full mockup activation
- `merged_live_bounded_descriptive_summary_selected_pass_cohort_aps_handoff_dispatch`: blue-green or other clearly merged-main implementation state for PR `#466`; it must not look like external export/download, connector/generic dispatch, destination selection, package mutation/reconstruction, schema/runtime/source widening, rendered UI behavior, broader UI, or full mockup activation
- `planning_only_descriptive_summary_selected_pass_cohort_external_export_download_readiness`: amber-brown or other clearly planning-only readiness-governance state for docs `96`/`97`; it must not look like live readiness, browser delivery, rendered download controls, public/signed URLs, connector/generic dispatch, destination selection, package mutation/reconstruction, schema/runtime/source widening, broader UI, or full mockup activation
- `merged_live_bounded_descriptive_summary_selected_pass_cohort_external_export_download_readiness`: blue-green or other clearly merged-main implementation state for PR `#479`; it must look like reference-only readiness over an existing APS bundle, not delivery, rendered download controls, public/signed URLs, connector/generic dispatch, destination selection, package mutation/reconstruction, schema/runtime/source widening, broader UI, or full mockup activation
- `branch_planning_only_descriptive_summary_selected_pass_cohort_external_export_download_delivery`: amber-brown or other clearly branch-local planning-only delivery governance state for docs `98`/`99`; it must not look like a live delivery endpoint, rendered download control, public/signed URL, connector/generic dispatch, destination selection, package mutation/reconstruction, schema/runtime/source widening, broader UI, or full mockup activation
