...
- branch-local docs `98`/`99` govern only a future same-origin associated-cohort delivery boundary after PR `#479`; they do not make delivery live by themselves and do not admit rendered controls, public/signed URLs, connector/generic dispatch, destination selection, package mutation, schema/runtime/source widening, broader UI, or full mockup activation
