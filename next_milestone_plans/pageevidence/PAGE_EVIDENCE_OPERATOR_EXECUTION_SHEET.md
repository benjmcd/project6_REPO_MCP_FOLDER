...
- Pass 1: cleanup + explicit close/cleanup semantics + service-layer evidence/projection separation
...
- the canonical merged authority worktree has already landed the service-layer shared-evidence / candidate-projection split for whole-document PageEvidence handling
- if this sheet is used again, treat that as a post-Pass 1 starting point unless a fresh truth check proves otherwise
