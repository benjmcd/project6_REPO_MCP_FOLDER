...
def find_bundle_artifact_by_id(*, bundle_id: str, reports_dir: str | Path) -> Path | None:
    pattern = f"*_{bundle_id}_aps_evidence_bundle_v1.json"
...
def get_persisted_bundle_page(
    *,
    ...
    candidate_path = find_bundle_artifact_by_id(bundle_id=bundle_id, reports_dir=settings.connector_reports_dir)
    ...
    payload["_bundle_ref"] = str(candidate_path)
