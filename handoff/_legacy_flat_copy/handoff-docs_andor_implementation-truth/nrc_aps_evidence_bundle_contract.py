...
def expected_bundle_file_name(*, scope: str, bundle_id: str) -> str:
    return f"{safe_path_token(scope)}_{str(bundle_id or '').strip()}_aps_evidence_bundle_v1.json"


def expected_failure_file_name(*, scope: str, bundle_id: str) -> str:
    return f"{safe_path_token(scope)}_{str(bundle_id or '').strip()}_aps_evidence_bundle_failure_v1.json"
