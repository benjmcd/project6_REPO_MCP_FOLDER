...
- SQLite-heavy tests remain deferred, especially [tests/test_api.py](../../tests/test_api.py)
...
2. SQLite-heavy test and proof refresh, including [tests/test_api.py](../../tests/test_api.py)
