...
program-context Phase 12 / D31 / F9 refresh and connector-program archive;
PR #2468 supersedes it only for the closeout-fix surfaces: the archive
correction, final trailer, README INDEX entry, and this pointer. This supersedes
the older header-block current-pointer through PR #2441 only for current
frontier selection; the historical PR #2441 / #2443 lines above remain true in
