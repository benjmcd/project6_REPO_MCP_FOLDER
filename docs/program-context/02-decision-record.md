...
## D29. Agent-inbox provenance is archived by hash, not raw-log commits (07-06)
...
- Alternatives: (a) commit raw inbox logs; (b) summarize without an integrity
  ...
  pointers.
- Decision: (c). The primary PR #2415 narrative lives in archived
  `for-claude.md` sections `M-A8-RUNTIME-GO REPORT 1`,
...
- Evidence: archived `for-claude.md` sha256
  ...
  independent `[From Claude]` `APPROVED` verdict block for PR #2415. The
  archived `for-codex.md` contains this durability-lane dispatch reference to
  PR #2415 but no A8 report narrative or independent verdict block. Live
