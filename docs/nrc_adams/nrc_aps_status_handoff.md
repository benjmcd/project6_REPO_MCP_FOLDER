...
6. current `main` also includes the merged planning-only `24_L3_WB_FREEZE.md` and `25_L3_QUAL1_FREEZE.md` docs from PR `#165`, but those docs remain deferred-scope prep artifacts and do not reopen or extend the settled later APS family packet
