...
7. open the bounded `context_dossier` handoff implementation lane admitted by that landed read-only freeze before any deterministic, review-packet, route/UI, runtime DB, or schema widening
