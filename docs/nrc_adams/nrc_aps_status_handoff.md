...
17. the next bounded continuation, if resumed beyond that landed freeze, is the write-enabled dedicated validate-only runtime/report-ref lane selected by `22_GATED_APS_VALIDATE_ONLY_RUNTIME_FREEZE.md`
