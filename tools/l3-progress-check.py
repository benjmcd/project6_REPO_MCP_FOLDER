...
def _check_source_boundary_contract(errors: list[str]) -> None:
    ...
    required_doc_terms = {
        ...
        CLOSEOUT_DOC: [
            "Status: bounded merged-main proof snapshot through PR #580 package review/construction/submit contract extraction.",
            "123_SOURCE_EXPANSION_FREEZE.md",
...
def _check_handoff_contract_extraction(errors: list[str]) -> None:
    ...
    required_doc_terms = {
        ...
        CLOSEOUT_DOC: (
            ...
            "proof/refactor hardening through PR #580",
