"""Add Layer 3 external local export receipt tables.

Revision ID: 0030_layer3_external_local_export
Revises: 0029_layer3_local_outbox_provider_private_handoff
...
def upgrade() -> None:
    create_table_idempotent(
        ...
        sa.Column("external_local_export_receipt_id", sa.String(length=36), nullable=False),
        sa.Column(
        ...
        sa.Column("export_state", sa.String(length=64), nullable=False),
        sa.Column("redacted_destination_label", sa.String(length=128), nullable=False),
        sa.Column("external_artifact_ref", sa.String(length=255), nullable=False),
        sa.Column("external_manifest_ref", sa.String(length=255), nullable=False),
        sa.Column("external_artifact_hash", sa.String(length=64), nullable=False),
        sa.Column("external_artifact_size_bytes", sa.Integer(), nullable=False),
        sa.Column("external_manifest_hash", sa.String(length=64), nullable=False),
        sa.Column("external_manifest_size_bytes", sa.Integer(), nullable=False),
        sa.Column("source_outbox_artifact_hash", sa.String(length=64), nullable=False),
        sa.Column("source_outbox_artifact_size_bytes", sa.Integer(), nullable=False),
        sa.Column("authority_basis_hash", sa.String(length=64), nullable=False),
        sa.Column("idempotency_key", sa.String(length=255), nullable=False),
        sa.Column("redacted_failure_code", sa.String(length=128), nullable=True),
        ...
        sa.PrimaryKeyConstraint("external_local_export_receipt_id"),
        sa.UniqueConstraint("client_request_id", name="uq_l3_external_local_export_client_request"),
        sa.UniqueConstraint("authority_basis_hash", name="uq_l3_external_local_export_authority_basis"),
        sa.UniqueConstraint("external_artifact_ref", name="uq_l3_external_local_export_artifact_ref"),
    )
    create_index_idempotent(
        "ix_l3_external_local_export_session",
        "l3_external_local_export_receipt",
        ["session_id"],
    )
    create_index_idempotent(
        "ix_l3_external_local_export_write_receipt",
        "l3_external_local_export_receipt",
        ["server_owned_local_outbox_write_receipt_id"],
    )
    create_index_idempotent(
        "ix_l3_external_local_export_state",
        "l3_external_local_export_receipt",
        ["export_state"],
    )
    create_table_idempotent(
        "l3_external_local_export_audit_event",
        sa.Column("external_local_export_audit_event_id", sa.String(length=36), nullable=False),
        sa.Column(
            "external_local_export_receipt_id",
            sa.String(length=36),
            sa.ForeignKey("l3_external_local_export_receipt.external_local_export_receipt_id"),
            nullable=False,
        ),
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.PrimaryKeyConstraint("external_local_export_audit_event_id"),
    )
    create_index_idempotent(
    ...
    create_index_idempotent(
        "ix_l3_external_local_export_audit_type_created",
        "l3_external_local_export_audit_event",
...
def downgrade() -> None:
    drop_index_idempotent(
        "ix_l3_external_local_export_audit_type_created",
        table_name="l3_external_local_export_audit_event",
    )
    drop_index_idempotent(
        "ix_l3_external_local_export_audit_receipt",
        table_name="l3_external_local_export_audit_event",
    )
    drop_table_idempotent("l3_external_local_export_audit_event")
    drop_index_idempotent(
        "ix_l3_external_local_export_state",
        table_name="l3_external_local_export_receipt",
    )
    drop_index_idempotent(
        "ix_l3_external_local_export_write_receipt",
        table_name="l3_external_local_export_receipt",
    ...
    drop_table_idempotent("l3_external_local_export_receipt")
