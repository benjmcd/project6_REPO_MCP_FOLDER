...
SESSION_STATUS_ACTIVE_LOADING = L3_SESSION_STATUS_ACTIVE_LOADING
SESSION_STATUS_ACTIVE_PLANNING = L3_SESSION_STATUS_ACTIVE_PLANNING
SESSION_STATUS_ACTIVE_EXECUTION = L3_SESSION_STATUS_ACTIVE_EXECUTION
SESSION_STATUS_COMPLETED = L3_SESSION_STATUS_COMPLETED
SESSION_STATUS_COMPLETED_WITH_WARNINGS = L3_SESSION_STATUS_COMPLETED_WITH_WARNINGS
SESSION_STATUS_FAILED = L3_SESSION_STATUS_FAILED
SESSION_STATUS_VALUES = frozenset(L3_SESSION_STATUS_VALUES)
TERMINAL_SESSION_STATUS_VALUES = frozenset(
    {
