...
APS_EVIDENCE_CITATION_PACK_SCHEMA_ID = "aps.evidence_citation_pack.v2"
APS_EVIDENCE_CITATION_PACK_FAILURE_SCHEMA_ID = "aps.evidence_citation_pack_failure.v2"
APS_EVIDENCE_CITATION_PACK_GATE_SCHEMA_ID = "aps.evidence_citation_pack_gate.v2"
APS_EVIDENCE_CITATION_PACK_SCHEMA_VERSION = 2
...
def expected_citation_pack_file_name(*, scope: str, citation_pack_id: str) -> str:
    return f"{safe_path_token(scope)}_{artifact_id_token(citation_pack_id)}_aps_evidence_citation_pack_v2.json"


def expected_failure_file_name(*, scope: str, citation_pack_id: str) -> str:
    return f"{safe_path_token(scope)}_{artifact_id_token(citation_pack_id)}_aps_evidence_citation_pack_failure_v2.json"
...
def build_citation(
    *,
    ...
    return {
        ...
        "page_start": source_row.get("page_start"),
        "page_end": source_row.get("page_end"),
        "unit_kind": source_row.get("unit_kind"),
