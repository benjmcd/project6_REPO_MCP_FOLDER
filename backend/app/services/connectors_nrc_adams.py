...
def _normalize_request_config(payload: dict[str, Any], submission_idempotency_key: str | None) -> dict[str, Any]:
    ...
    document_processing_engine_explicit = bool(str(config.get("document_processing_engine") or "").strip())
...
def _run_target_artifact_pipeline(
    *,
    ...
    detection = nrc_aps_artifact_ingestion.detect_media_type(
        content=download_result.content,
        ...
        payload = nrc_aps_artifact_ingestion.build_target_artifact_payload(
            **context,
            ...
            failure={
                ...
                "evidence": {
                    "declared_content_type": detection.get("declared_content_type"),
    ...
    diagnostics_payload = {
        ...
        "accession_number": context.get("accession_number"),
        "declared_content_type": extraction.get("declared_content_type"),
        "sniffed_content_type": extraction.get("sniffed_content_type"),
        "effective_content_type": extraction.get("effective_content_type"),
