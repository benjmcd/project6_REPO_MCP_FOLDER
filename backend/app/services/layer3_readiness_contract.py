    ...
    return {
        **base_response(EXECUTION_READINESS_SCHEMA_ID),
        ...
        "deferred_decisions": {
            ...
            "revision_recovery": "admitted only as preview-refresh recovery from terminal pre-approval revision-control state; approved-plan correction still requires later freeze",
