...
STATE_ACTION_ADMITTED_CAPABILITIES = (
    ...
    {
        "capability": "package_supersession_commit_entry",
        "admitted": True,
        "source_gate": "126_PACKAGE_COMMIT_FREEZE",
        "scope": "durable immutable package supersession lineage record with no package row or payload mutation",
    ...
    },
    {
        ...
        "scope": "separate replacement output-package namespace rows over verified manifest artifacts with no source package row mutation or payload write",
    ...
    {
        "capability": "approved_plan_cancel_without_replacement",
        "admitted": True,
        "source_gate": "136_APPROVED_PLAN_CANCEL_ENTRY_FREEZE",
        "scope": "server-authorized cancellation of the current approved plan without replacement, pass-run, execution, package, handoff/export, connector, provider, source, or artifact writes",
        "owner_service": "backend/app/services/layer3_approved_plan_correction.py",
        "blocked_downstream": [
            "approved_plan_supersession",
            "approved_plan_replacement",
            "approved_plan_reopening",
            "l3_pass_run_creation",
            "analysis_run_creation",
            "output_package_handoff_export_artifacts",
            "provider_public_url",
...
def build_state_action_contract(
    *,
    ...
    approved_plan_cancel_decisions: Iterable[str],
    ...
    return {
        ...
        "decision_sets": {
            ...
            "approved_plan_cancel": sorted(approved_plan_cancel_decisions),
