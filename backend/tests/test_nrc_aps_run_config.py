...
class TestNrcApsRunConfig(unittest.TestCase):
    ...
    def test_visual_lane_mode_preserves_candidate_b_opendataloader_page_evidence_v1(self):
        """Approved Candidate B page-evidence mode must survive normalization."""
        config = connectors_nrc_adams._normalize_request_config(
            {
                "mode": "strict_builder",
                "wire_shape_mode": "shape_a",
        ...
        self.assertEqual(config["visual_lane_mode"], "candidate_b_opendataloader_page_evidence_v1")
