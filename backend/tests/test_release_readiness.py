...
def test_release_readiness_manifest_is_profile_neutral_and_maps_existing_gates():
    ...
    assert manifest["release"]["milestone"] == "M-RC3-SEC-XBRL-OFFLINE-ACCEPTANCE"
    assert manifest["release"]["version"] == "0.3.0-rc1"
...
def test_release_readiness_runner_reports_pass_and_fail_paths(tmp_path):
            ...
            json.dumps(
                {
                    ...
                    "release": {
                        "milestone": "M-RC3-SEC-XBRL-OFFLINE-ACCEPTANCE",
                        "version": "0.3.0-rc1",
                    },
    ...
    assert pass_report["build_identity"]["version"] == "0.3.0-rc1"
