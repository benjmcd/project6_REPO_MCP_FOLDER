...
def test_layer3_readiness_contract_is_shared() -> None:
    ...
    assert direct["candidate_b_broader_eligible_corpus_scope_readiness_audit_admitted"] is True
    assert direct["candidate_b_broader_eligible_corpus_scope_readiness_audit_endpoint"] == (
    ...
    assert direct["candidate_b_full_corpus_operator_workflow_execution_boundary_admitted"] is True
    assert direct["candidate_b_full_corpus_operator_workflow_execution_boundary_endpoint"] == (
        "/api/v1/layer3/source/ingestion/candidate-b/full-corpus/operator-workflow/execution/boundary"
    )
    assert direct["candidate_b_full_corpus_operator_workflow_process_execution_admitted"] is True
    ...
    assert direct["candidate_b_full_corpus_operator_workflow_completion_monitor_admitted"] is True
    assert direct["candidate_b_full_corpus_operator_workflow_completion_monitor_endpoint"] == (
        "/api/v1/layer3/source/ingestion/candidate-b/full-corpus/operator-workflow/completion/monitor"
    )
    assert direct["candidate_b_full_corpus_operator_repeatability_checkpoint_admitted"] is True
    assert direct["candidate_b_full_corpus_operator_repeatability_checkpoint_endpoint"] == (
        "/api/v1/layer3/source/ingestion/candidate-b/full-corpus/operator-workflow/repeatability/checkpoint"
    )
    assert direct["candidate_b_full_corpus_repeatability_rerun_trial_admitted"] is True
    assert direct["candidate_b_full_corpus_repeatability_rerun_trial_endpoint"] == (
        "/api/v1/layer3/source/ingestion/candidate-b/full-corpus/operator-workflow/repeatability/rerun-trial"
    )
    assert direct["candidate_b_full_corpus_repeatability_acceptance_closeout_admitted"] is True
    ...
    assert direct["candidate_b_full_corpus_operator_workflow_retry_worker_attempt_admitted"] is True
    assert direct["candidate_b_full_corpus_operator_workflow_retry_worker_attempt_endpoint"] == (
        "/api/v1/layer3/source/ingestion/candidate-b/full-corpus/operator-workflow/retry/worker/attempt"
    )
    assert direct["candidate_b_full_corpus_operator_workflow_retry_progress_checkpoint_admitted"] is True
