# Agent Bake-Off Prompt: Jules

## 1. How To Use This File

Use this file when running the controlled bake-off in Jules.
...
Paste the following into Jules as the first prompt for the branch/worktree:
...
- actual code edits belong in your isolated Jules repo branch/worktree
...
You must read and treat the following planning docs as the authority for scope and implementation shape:
...
Not in scope for this bake-off slice:
...
The golden runtime for validation is:
...
For this round, do not modify files. Instead, produce:
...
- C:\Users\benny\OneDrive\Desktop\project6_REPO_MCP_FOLDER\frontend_UI_plans\agent_workspaces\jules\logs\
- C:\Users\benny\OneDrive\Desktop\project6_REPO_MCP_FOLDER\frontend_UI_plans\agent_workspaces\jules\deliverables\

If you believe a repo-confirmed blocker forces a scope change, state it explicitly and stop there instead of broadening scope on your own.
```

## 3. Round 1 Implementation Prompt

Use this only after the dry-run output looks acceptable.

```text
Proceed with implementation for Slice 01 in this isolated Jules branch/worktree for:
...
- C:\Users\benny\OneDrive\Desktop\project6_REPO_MCP_FOLDER\frontend_UI_plans\agent_workspaces\jules\deliverables\
- C:\Users\benny\OneDrive\Desktop\project6_REPO_MCP_FOLDER\frontend_UI_plans\agent_workspaces\jules\logs\
- C:\Users\benny\OneDrive\Desktop\project6_REPO_MCP_FOLDER\frontend_UI_plans\agent_workspaces\jules\patches\
- C:\Users\benny\OneDrive\Desktop\project6_REPO_MCP_FOLDER\frontend_UI_plans\agent_workspaces\jules\screenshots\
